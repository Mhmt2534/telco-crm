...
2. **Modül klasörünü ve `pom.xml`'ini oluştur**
   ...
   <parent>
       <groupId>com.turkcell.springmicroservices</groupId>
       <artifactId>telco-crm-platform</artifactId>
...
| Araç | URL | Açıklama |
|---|---|---|
| Kafka UI | http://localhost:8085 | Kafka topic ve mesajlarını görüntüle |
| Mailpit | http://localhost:8025 | Mock e-posta sunucusu (SMTP: 1025) |
| RedisInsight | http://localhost:5540 | Redis içeriğini görüntüle |
