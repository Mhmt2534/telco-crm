...
* **Kabul Kriterleri (Checklist):**
* [x] `notification-service` (9007) üzerinde `NotificationTemplate` entity'si ve şablon ekleme/düzenleme CRUD endpoint'leri yazılmalı.


* [x] Şablon içerisindeki dinamik alanlar için placeholder (Örn: `Merhaba {customerName}`) yapısı kurulmalı.


* [x] Gerçek maillerin havada kalmaması için yerel ortam docker-compose konfigürasyonuna sahte mail sunucusu olan `Mailpit` entegrasyonu dahil edilmeli.
